...
def get_vt_info(hash):
    ...
    if vt_response_json.get("verbose_msg").startswith('Invalid'):
        ...
        file_info['positives']    = int(vt_response_json.get('positives'))
        file_info['total_score']  = int(vt_response_json.get('total'))
        ...
        # Check overall score. I.e has sample been classed as malacious or not.
